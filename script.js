...
//Método pop: destructive method que borra el último elemento del array. 
universo.pop();
...
//Método unshift: permite agregar un elemento al principio de un arreglo
...
//Método indexOf: Devuelve la posición (el index, un número) en el array del valor 
//del array que le pasamos por parámetro.

console.log(numbers.indexOf(8));
console.log(animales.indexOf('gato'));
console.log(universo.indexOf('sol'));

//Método slice: devuelve la copia de un array con la posibilidad de especificar el inicio
// y el final de la copia. Sin que el array original se vea afectado.
...
const users = [
  ...
  for(let i = 1 ; i <= users.length; i++){
    ...
    console.log(`Name of user: ${users[i].name}, Username: ${users[i].username} Address: lat ${users[i].address.geo.lat}, long ${users[i].address.geo.lng}`);
